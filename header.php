...
<html lang="en" dir="ltr">
  <head>
    ...
    <?php include 'nav-menu-styles.php' ?>
  </head>
  <body>
...
<!-- Section 1 -->
    <div class="">
      ...
      <!-- no need to type index.php, just writing "./" is sufficient as the index is the default file for any server -->
  ...
  <script>
  // no need to write type attr since js native for da web. make the code cleaner!
    ...
    // involking the function on load for easier development
    // openNav()
    ...
    // submenu
    const hoveredEle = document.querySelector('#hovered')
    const subMenu = document.querySelector('#submenu')
    const menuLinks = document.querySelectorAll('.overlay-content a') 

    hoveredEle.onmouseover = _ => subMenu.style.visibility = "visible"
